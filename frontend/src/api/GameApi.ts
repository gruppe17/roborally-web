...
class GameApi {
    ...
    private readonly BACKEND_URL = "https://roborally-backend.herokuapp.com" //"http://localhost:8080" // process.env.BACKEND_URL //   "https://roborallyserver.tobiasmaneschijn.com/"
